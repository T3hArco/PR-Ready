...
public class QuestionManager {
     ...
     */
    public Integer addQuestion(String title, String text, AnswerType questionType, Integer questionExtraId) throws DuplicateQuestionException {
        ...
        try {
            ...
            Question question = new Question(title, text, questionType, 1);
